...
<div id="whatsapp-modal"
  ...
  <div id="whatsappModalContent"
    ...
    <div class="flex items-center justify-between border-b pb-3">
      ...
      <button id="closeWhatsappModal" class="text-slate-500 hover:text-slate-700">✕</button>
    </div>
    ...
    <form method="POST" action="" class="mt-4 space-y-4">
      ...
      {{-- Submit --}}
        ...
        <button type="button" class="px-4 py-2 bg-gray-300 rounded" id="closeWhatsappBtn">Close</button>
