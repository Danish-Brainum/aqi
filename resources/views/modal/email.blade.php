...
<div id="email-modal"
  ...
  <div id="emailModalContent"
    ...
    <div class="flex items-center justify-between border-b pb-3">
      ...
      <button id="closeEmailModal" class="text-slate-500 hover:text-slate-700">✕</button>
    </div>

    {{-- Form --}}
    <form method="POST" action="{{ route('sendEmails') }}" class="mt-4 space-y-4">
      @csrf        
        {{-- City --}}
        <div>
      ...
      {{-- Submit --}}
        ...
        <button type="button" class="px-4 py-2 bg-gray-300 rounded" id="closeEmailBtn">Close</button>
